<?php
$lang = array(
    "conexion" => "A conexión extableceuse con éxito",
    "Inicio" => "Inicio",
    "Precios" => "Prezos",
    "Contacto" => "Contacto",
    "Descripcion" => "Esta é a descripcion do meu sitio Web en galego",
    "Titular" => "A miña páxina web en galego",
    "en" => "Inglés",
    "es" => "Español",
    "it" => "Italiano",
    "gl" => "Galego",
    ...
    "Nueva Categoria" => array(
        "Boton" => "Nova categoría",
        "Nombre" => "Nome",
        "Descripcion" => "Descrición",
        "Registrarse" => "Rexistro",
        "Actualizar" => "Para actualizar",
        "Cancelar" => "Cancelar",
        "Fail" => "Algo fallou"
    ),
