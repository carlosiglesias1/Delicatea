      ...
      <?php } else { ?>
        <ul>
          ...
          <li>
            ...
            <input type="text" name="descripcion" value="<?= escapar($campos->getDescripcionCorta()) ?>">
          </li>
          <li>
            <label for="name"><?php echo $lang['Nuevo Articulo']['DescripcionL']; ?></label>
            <input type="text" name="descripcion2" value="<?= escapar($campos->getDescripcionLarga()) ?>">
          </li>
          <li>
            <label for="marca">Marca</label>
            <select name="marca" id="marca">
          ...
          <li>
            ...
            <select name="subcategoria" id="subcategoria">
              <?php
              $subcategoria = $articuloDAO->getForeignValue('subcategoria');
              foreach ($subcategoria as $fila) { ?>
                <option value="<?= $fila['idSubCategoria'] ?>"><?= $fila['nombre'] ?></option>
              <?php }
              ?>
          ...
          <li>
            <label for="coste">Coste</label>
            <input type="number" name="coste" id="coste" step="0.01" value="<?= $campos->getCoste() ?>">
          </li>
          <li>
            <label for="images">Imágenes</label>
            <div class="input-images">
