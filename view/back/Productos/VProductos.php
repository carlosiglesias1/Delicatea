...
<body>
    ...
    <div class="contenedor">
        ...
        <div class="contenido">
            ...
            <a href="<?= 'Cprods.php?menu=1&lang=' .
                            $_GET['lang'] .
                            '&idTarifa=' .
                            $_GET['idTarifa'] ?>" class="New_Button"><?php echo $lang['Nuevo Articulo']['Boton']; ?></a>
            ...
            <?php if ($_GET['idTarifa'] != 0) { ?>
                <a href="<?= $_SESSION['INDEX_PATH'] .
                                'Back/Controladores/BCcontrol.php?menu=8&lang=' .
                                $_GET['lang'] ?>" class="return"><?= $lang['Tabla Tarifas']['Volver'] ?></a>
            <?php } ?>
        </div>
        <form method="post">
                ...
                <tbody>
                    <?php if ($prods && sizeof($articulo->getAll()) > 0) {
                        foreach ($prods as $fila) { ?>
                            <tr>
                                <td><input type="checkbox" name="<?= escapar(
                                                                        $fila->getIdArticulo()
                                                                    ) ?>" id="<?= escapar(
                                                $fila->getIdArticulo()
                                            ) ?>" class="option"></td>
                                ...
                                <?php } ?>
                                <td class="options">
                                    <a href="<?= 'Cprods.php?menu=3&id=' .
                                                    escapar($fila->getIdArticulo()) .
                                                    '&lang=' .
                                                    $_GET['lang'] .
                                                    '&idTarifa=' .
                                                    $_GET['idTarifa'] ?>" class="Editar"><i class="icofont-edit-alt"></i> <?= $lang['Tabla Articulos']['Editar'] ?></a>
                                </td>
                            </tr>
                    <?php }
                    } ?>
